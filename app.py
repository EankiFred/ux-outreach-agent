...
# Page
# ----------------------------
st.set_page_config(page_title="Agentiq AI — Decision Support Agent", layout="wide")
st.title("Agentiq AI — Decision Support Agent")
st.caption("Decision-support briefs for agentic AI prototypes. No outreach. Human-in-the-loop by design.")
